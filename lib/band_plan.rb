module BandPlan
  ...
  BANDS = [
    ...
    { name: '15m',  range: '21.000–21.450',modes: 'CW/SSB',     calling: '21.285 SSB 21.000 CW', notes: 'solar dependent' },
    ...
    { name: 'CB',   range: '26.965–27.405', modes: 'AM/FM/SSB', calling: '27.555 SSB  ch19 27.185',notes: '11m, 40 ch' },
  ].freeze
